...
import { IconArrowBackUp, IconLayoutDashboard, IconMenu2, IconReceipt, IconSettings } from '@tabler/icons-react';
...
const navigation = [
  ...
  { name: 'Rechnung', href: '/rechnung', icon: IconReceipt },
];

const externalNavigation = [
  { name: 'Rechnung', href: '/gateway/apps/699ecef9a5f7a7df385d883f?template=list_page', icon: IconReceipt },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/699ecef9a5f7a7df385d883f?template=list_page"
